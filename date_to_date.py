...
if __name__ == '__main__':
    ...
    wife = Person('Юля', datetime.datetime(2018, 2, 24, 0, 0, 0, 0))
    zjat = Person('Витя', datetime.datetime(2017, 6, 15, 0, 0, 0, 0))
    nephew = Person('Ваня', datetime.datetime(2017, 10, 5, 0, 0, 0, 0))
    iam = Person('Паша', datetime.datetime(2017, 8, 26, 0, 0, 0, 0))
    new_year = Person('Новый год', datetime.datetime(2018, 1, 1, 0, 0, 0))
    ...
    print('Д.Р.:')
    dad.date = datetime.datetime(2017, 10, 4, 0, 0, 0, 0)
    sister.date = datetime.datetime(2018, 1, 21, 0, 0, 0, 0)
